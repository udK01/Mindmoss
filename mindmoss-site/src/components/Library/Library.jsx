...
export default function Library() {
  ...
  return (
    <section className="flex flex-col items-center h-full min-h-screen relative py-40">
      ...
      <div className="w-full max-w-[80%] flex items-center justify-end 2xs:flex-col md:flex-row pb-[4%]">
        <div className="w-full flex justify-between items-center">
          <GenreFilter />
          <button
            className="px-6 py-2 2xs:mr-0 md:mr-10 rounded-md z-10 bg-highlight text-grass hover:bg-black hover:text-white transition-all duration-300"
